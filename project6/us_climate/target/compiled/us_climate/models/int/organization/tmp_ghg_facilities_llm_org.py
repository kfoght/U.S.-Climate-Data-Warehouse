...
def ref(*args, **kwargs):
    refs = {"tmp_ghg_facilities_no_org": "kiaraerica.dbt_us_climate_int.tmp_ghg_facilities_no_org"}
    key = '.'.join(args)
...
class this:
    ...
    identifier = "tmp_ghg_facilities_llm_org"
    
    def __repr__(self):
        return 'kiaraerica.dbt_us_climate_int.tmp_ghg_facilities_llm_org'
